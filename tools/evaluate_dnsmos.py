...
'''
python tools/evaluate_dnsmos.py -t wav/noisy
'''
...
def main(args):
    model_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'DNSMOS')
    ...
    result = {
        'OVRL_raw' : round(mean_OVRL_raw,3),
        'SIG_raw' : round(mean_SIG_raw,3),
        'BAK_raw' : round(mean_BAK_raw,3),
